...
import PartialExample from '@site/src/components/shared/_markdown-partial-example.mdx';
import AssistantGovernance from '@site/src/components/shared/_assistant_governance.mdx';
import Table1 from '@site/src/components/shared/table1.mdx';


# About UiPath 2025.10
...
You can learn more about the features of the [productName] on our dedicated features page.
