...
<<<<<<< HEAD:user-guide/Getting started/Overview of the user interface.mdx
**Solutions** is the admin interface and allows you to manage your solution packages and deployments.
=======
**Solutions**  is the admin interface and allows you to manage your solution packages and deployments.
>>>>>>> 80bec93ff75ffb87bbc83f2d175383ce8c48ff76:Solutions user guide/Getting started/Overview of the user interface.mdx
