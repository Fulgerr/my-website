...
!['Validation errors' image](/images/Solutions/sConflict resolution=GUID-CE7EFB60-9DA0-4CF2-B50E-04DF12A63AAF=1=en=Default.png)
...
For an overview of all deployment statuses, refer to [Checking the deployment status](https://docs.uipath.com/solutions-management/automation-cloud/latest/user-guide/checking-the-deployment-status).
...
!['Link to existing' image](/images/Solutions/link to existing=GUID-1AD67087-5498-4283-89D7-AFECF91E54F0=1=en=Default.png)
2. Select the existing component you want to link to from the **component name** dropdown list.  
!['Link to existing component' image](/images/Solutions/Link=GUID-7F0E35A7-0FC1-4625-B16E-45C201EE693A=1=en=Default.png)
3. Select **Link**.
